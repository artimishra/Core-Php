		...
		<div class="col-md-7">
                    <div class="side-box" id="inquiry">
                        ...
                        <p>Fill in your details and a our Specialist will get back to you shortly.</p>
                                                                               <form class="form-horizontal" method="post" action="configcontact.php" onsubmit="return checkForm(this);">
																			   <div class="form-group">
                                                                                
                                                                                
                                                                                    <input type="hidden" class="form-control" id="form_id" placeholder="" required="" name="form_id" value="3">
                                                                                </div>
                                                                               <div class="form-group">
                                                                               <label for="event_name" class="col-md-3 control-label">
	                                                                           <font size="3" face="times new roman">Name:</font> </label>     
	                                                                           <div class="col-md-7">
                                                                               <input type="text" class="form-control" id="sname" placeholder="" required="" name="sname"><br>
                                                                               </div>
                                                                               </div>
																			   <div class="form-group">
                                                                                <label for="website" class="col-md-3 control-label"><font size="3" face="times new roman">Email-id:</font> </label>
                                                                                <div class="col-md-7">
                                                                                    <input type="email" class="form-control" id="semail" placeholder="" name="semail">
                                                                                </div>
                                                                            </div><br>
																			   ...
																			   <div class="form-group">
                                                                                ...
                                                                                <div class="col-md-7">
                                                                                    <input type="text" class="form-control" id="sphone" placeholder="" required="" name="sphone">
                                                                                </div>
                                                                            </div><br>
																			...
																			<div class="form-group">
                                                                                <label for="event_type" class="col-md-3 control-label"><font size="3" face="times new roman">Purpose:</font> </label>
                                                                                <div class="col-md-7">
																			...
																			<div class="form-group">
                                                                               <label for="event_name" class="col-md-3 control-label">
	                                                                           <font size="3" face="times new roman"> Organiation Name:</font> </label>     
	                                                                           <div class="col-md-7">
                                                                               <input type="text" class="form-control" id="organ_name" placeholder="" required="" name="organ_name"><br>
                                                                               </div>
                                                                               </div>
